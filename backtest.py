...
def run_backtest():
    ...
    print("Genel piyasa yönü için BTC/USDT verisi çekiliyor...")
    try:
    ...
    # 1. Aşama: Tüm zamanlardaki filtrelenmiş verileri topla
    all_filtered_data = []
    ...
    # 2. Aşama: Tek seferde yapay zekaya sor
    all_decisions = []
    if all_filtered_data:
        try:
            # Eğer veri boyutu çok büyükse Groq token sınırına takılabilir, ama user tek seferde atmamızı istedi.
    ...
    # Yapay zeka sinyallerini zamana göre grupla
    signals_by_time = {}
    ...
    # 3. Aşama: Zaman çizelgesinde simülasyonu çalıştır
    for i, ts in enumerate(timestamps):
        current_prices_dict = {}
        ...
        for d in current_signals:
            ...
            # Zaten bu coin'de aktif işlem var mı?
