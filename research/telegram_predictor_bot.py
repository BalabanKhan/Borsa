...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = (
        ...
        "Bot varsayılan olarak **son 60 günün** verisine bakıp **önümüzdeki 7 günü** tahmin eder. "
        "Ancak isterseniz geçmiş gün (context) ve tahmin edilecek gün (horizon) sayılarını kendiniz belirleyebilirsiniz:\n\n"
        "`/tahmin <SEMBOL> <TÜR> <GEÇMİŞ_GÜN> <GELECEK_GÜN>`\n\n"
        "Örnek: `/tahmin THYAO.IS bist 60 14`\n"
        "_(Yukarıdaki komut son 60 güne bakıp 14 günlük tahmin yapar.)_\n\n"
