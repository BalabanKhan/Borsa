...
def test_calculate_conviction():
    ...
    scores = {
        ...
        "apply_bear_penalty": True   # Will multiply by 0.6
    }
    ...
    # + (-20.0) + (-10.0) = 70.0
    # apply_bear_penalty -> 70.0 * 0.6 = 42.0
