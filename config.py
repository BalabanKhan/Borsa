...
TOP_CRYPTO_SCAN = [
    "BTC/USDT", "ETH/USDT", "RE/USDT", "NIGHT/USDT", "SOL/USDT", "ZEC/USDT", 
    "WLD/USDT", "XRP/USDT", "BNB/USDT", "AVAX/USDT", "TAO/USDT", "TRX/USDT", 
    "XPL/USDT", "NEAR/USDT", "XLM/USDT", "HEI/USDT", "DOGE/USDT", "BICO/USDT", 
    "MEGA/USDT", "SUI/USDT", "ENA/USDT", "SYN/USDT", "EIGEN/USDT", "ADA/USDT", 
    "ASTER/USDT", "U/USDT", "AXS/USDT", "ORDI/USDT", "JTO/USDT", "UNI/USDT", 
    "LINK/USDT", "MET/USDT", "FET/USDT", "LTC/USDT", "ONDO/USDT", "XAUT/USDT", 
    "OPG/USDT", "PEPE/USDT", "ACT/USDT", "TON/USDT", "PORTAL/USDT", "AAVE/USDT", 
    "WCT/USDT", "BEL/USDT", "PAXG/USDT", "HBAR/USDT", "BCH/USDT", "EDEN/USDT", 
    "ALLO/USDT", "LUMIA/USDT"
]
