...
from circuit_breaker_v5 import is_circuit_open, get_status_message as cb_status
...
async def run_market_scan(bot, chat_ids, watch_bot=None):
    ...
    # 🧹 Garbage Collection: Büyük veri yapılarını temizle
    del signals
    del scan_metrics
    gc.collect()
...
async def main():
    ...
    while True:
        try:
            ...
            # Döngü sonu rutin RAM temizliği
            gc.collect()
